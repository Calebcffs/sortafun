...
- animation studio - a tiny flipbook animator (`flipbook.html`). Draw frames by hand (pen, line, square, circle, eraser), onion-skin the previous frames, flip through them at 12fps. Not a game, no score. Frames autosave to `localStorage` (this browser only). Sound mode is planned, not built.
